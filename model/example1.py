...
class NestPost(db.Model):
    ...
    def __init__(self, first_name, content, user_id, group_id, image_url):
        """
    ...
    def __repr__(self):
        ...
        """
        return f"Post(id={self.id}, first_name={self._first_name}, content={self._content}, user_id={self._user_id}, group_id={self._group_id}, image_url={self._image_url})"
...
def initNestPosts():
    ...
    with app.app_context():
        ...
        p1 = NestPost(first_name='Calculus Help', content='Need help with derivatives.', user_id=1, group_id=1, image_url="toby1.png")  
        p2 = NestPost(first_name='Game Day', content='Who is coming to the game?', user_id=2, group_id=2, image_url="toby2.png")
        p3 = NestPost(first_name='New Releases', content='What movies are you excited for?', user_id=3, group_id=3, image_url="toby3.png")
        p4 = NestPost(first_name='Study Group', content='Meeting at the library.', user_id=1, group_id=1, image_url="toby4.png")
