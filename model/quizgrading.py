...
def initQuizGrading():
    ...
    with app.app_context():
        ...
        p1 = QuizGrading(title='Calculus Help', content='Need help with derivatives.', user_id=1, group_id=1, image_url="toby1.png")  
        p2 = QuizGrading(title='Game Day', content='Who is coming to the game?', user_id=2, group_id=2, image_url="toby2.png")
        p3 = QuizGrading(title='New Releases', content='What movies are you excited for?', user_id=3, group_id=3, image_url="toby3.png")
        p4 = QuizGrading(title='Study Group', content='Meeting at the library.', user_id=1, group_id=1, image_url="toby4.png")
